            ...
            <form method="POST">
              ...
              <div class="row">
                <div class="form-group col-md-3">
                  ...
                  $ordenes = ControladorOrdenProduccion::ctrMostrarOrdenes($item,$valor);    
                  ...
                  if (!$ordenes) {
                    ...
                    $id_orden_produccion = $value["id_orden_produccion"]+1;
                  }
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nuevoId" name="nuevoId" value="<?php echo $id_orden_produccion; ?>" required readonly>
                  </div>
                </div>
              </div>
