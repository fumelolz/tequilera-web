...
$jsonData = '{ 
	"data": [';
		...
		$botones = "<center><div class='btn-group-sm'><button class='btn btn-warning btnEditarProducto' idProducto='".$productos[$i]["id_producto"]."' data-toggle='modal' data-target='#modalEditarProducto'><i class='fas fa-pencil-alt'></i></button><button class='btn btn-danger btnEliminarProducto' descripcion='".$productos[$i]["descripcion"]."' idProducto='".$productos[$i]["id_producto"]."' foto='".$productos[$i]["img"]."'><i class='fas fa-times'></i></button></div></center>";
